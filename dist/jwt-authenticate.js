...
(function (global, factory) {
	...
	(global.JwtAuthenticate = factory());
...
var defaultOptions = {
  ...
  storageNamespace: 'jwt-authenticate',
  cookieStorage: {
 ...
 * and adjusted to fit jwt-authenticate library
 */
...
var JwtAuthenticate$1 = function JwtAuthenticate(overrideOptions, config) {
  var $http = config.$http;

  // Override default options
  var options = objectExtend(
    objectExtend({}, defaultOptions),
    overrideOptions
  );
  ...
  if (
    ...
    throw new Error('You have to setup request and/or response interceptors')
  }
 ...
 * @return {Boolean}
 */
JwtAuthenticate$1.prototype.isAuthenticated = function isAuthenticated () {
 ...
 */
JwtAuthenticate$1.prototype.getToken = function getToken () {
 ...
 */
JwtAuthenticate$1.prototype.setToken = function setToken (response) {
...
JwtAuthenticate$1.prototype.getPayload = function getPayload () {
  var token = this.storage.getItem(this.tokenName);
 ...
 */
JwtAuthenticate$1.prototype.login = function login (user, requestOptions) {
    var this$1 = this;
 ...
 * @return {Promise}             Request promise
 */
JwtAuthenticate$1.prototype.register = function register (user, requestOptions) {
    var this$1 = this;
 ...
 * @return {Promise}              Request promise
 */
JwtAuthenticate$1.prototype.logout = function logout (requestOptions) {
    var this$1 = this;
 ...
 * @return {Promise}             Request promise
 */
JwtAuthenticate$1.prototype.authenticate = function authenticate (provider, userData, requestOptions) {
    var this$1 = this;
